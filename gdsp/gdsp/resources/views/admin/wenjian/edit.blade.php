...
@section('content')
    ...
    <div class="right-product my-index right-full" style="left: 10px;">
        ...
        <div class="framework" style="margin-bottom:0;">
            ...
            <div class="">
                <input type="button" value="刷新一下" onclick="window.location.href='{{url('/admin/wenjian/edit',$data->id)}}'" class="btn btn-primary"/>
                <form id="fm" action="{{url('/admin/wenjian/edited')}}" method="post" onsubmit="return addFinancing()" enctype="multipart/form-data">
                    <!-- a form -->
                    ...
                    <ul class="form" style="width:800px;margin-left:50px;">
                        <li>
                            ...
                            <div class="right form-group">
                                <input validate="" style="width:300px" maxlength="35" class="pledge " id="name" name="name" value="{{$data->name}}" type="text">
                                <b class="however"></b>
                        ...
                        <li>
                            ...
                            <div class="right form-group">
                                <img style="width: 200px; height: 200px;" src="{{asset($data->url)}}">
                                <input id="img" class="file" name="img" style="width:200px" type="file" accept="image/png,image/gif,image/jpeg"/ >
                                <b class="however"></b>
                                <i class="tip" style="display:inline"> 在前台显示的图片！</i><label></label>
                            </div>
                        </li>
                        <li>
                            <div class="left">
                            ...
                            <div class="right form-group">
                                ...
                                <input validate="" style="width:300px" maxlength="35" class="pledge " id="dir_name" name="dir_name" value="{{$data->dir_name}}" type="text">
                                <b class="however"></b>
                        ...
                        <li>
                            ...
                            <div class="right form-group"  style="display:inline">
                                <select name="show"  style="width: 107px;height:32px;font-weight: bold; border: solid 1px #ddd;">
                                    <option value="1" @if(!empty($data->show) and $data->show==1) selected="selected" @endif  style="color: green;">显示</option>
                                    <option value="2" @if(!empty($data->show) and $data->show==2) selected="selected" @endif  style="color: red;">关闭</option>
                                </select>
                                <label></label>
                            </div>
...
<br>
                        <li>
                            <div class="left" >
                                <b>最后修改时间：{{$data->updatetime}}</b>
                            </div>
                        </li>
<br>
                        <li>
                            <div class="left" >
                                <b>创  建  时 间：{{date("Y-m-d H:i:s",$data->createtime)}}</b>
                            </div>
                        </li>
                        <br>
                        <li>
