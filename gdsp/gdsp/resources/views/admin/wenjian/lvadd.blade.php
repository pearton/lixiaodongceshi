...
@section('content')
    ...
    <div class="right-product my-index right-full" style="left: 10px;">
        <div class="row">
            <div class="span6">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{url('/admin/wenjian/lv',$id)}}">分级列表</a> <span class="divider">></span>
                    </li>
        ...
        <div class="framework" style="margin-bottom:0;">
            ...
            <div class="">
                <input type="button" value="刷新一下" onclick="window.location.href='{{url('/admin/wenjian/lv/add',$id)}}'" class="btn btn-primary"/>
                <form id="fm" action="{{url('/admin/wenjian/lv/added')}}" method="post" onsubmit="return addFinancing()">
                    <!-- a form -->
