...
@section('content')
    ...
    <div class="right-product my-index right-full" style="left: 10px;">
        ...
        <div class="framework" style="margin-bottom:0;">
            ...
            <div class="">
                <input type="button" value="刷新一下" onclick="window.location.href='{{url('/admin/wenjian/add')}}'" class="btn btn-primary"/>
                <form id="fm" action="{{url('/admin/wenjian/added')}}" method="post" onsubmit="return addFinancing()" enctype="multipart/form-data">
                    <!-- a form -->
                    ...
                    <ul class="form" style="width:800px;margin-left:50px;">
                        ...
                        <li>
                            ...
                            <div class="right form-group">
                                <img style="width: 200px; height: 200px;" id="img" src="">
